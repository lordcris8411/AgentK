...
const dictionaries = {
  "zh-CN": {
    ...
    environmentPromptDescription: "向模型附加当前操作系统、架构和命令 Shell 信息，减少在 Windows 上误用 Linux 专用命令。切换后会重新加载空闲的 Pi 进程。",
    autoCompact: "自动整理上下文",
  ...
  "en-US": {
    ...
    environmentPromptDescription: "Append the current operating system, architecture, and command-shell details to the model prompt to avoid platform-specific command mistakes. Idle Pi processes reload after this changes.",
