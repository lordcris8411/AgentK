...
const dictionaries = {
  "zh-CN": {
    ...
    reasoningDescription: "启用后，可在会话中选择思考级别。请只为确认支持推理的模型启用。",
  ...
  "en-US": {
    ...
    reasoningDescription: "When enabled, conversations can select a thinking level. Enable it only for models that support reasoning.",
