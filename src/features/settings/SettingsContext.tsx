...
const dictionaries = {
  "zh-CN": {
    ...
    filePlugin: "文件插件",
    piSkill: "Pi Skill",
    filePluginDependency: "文件插件关闭时会同时关闭 Pi Skill；开启 Pi Skill 时会同时开启文件插件。",
    noResources: "没有发现此类资源。",
    resourcesLocked: "有 Pi 进程正在工作。Skills 和 Extensions 将在所有进程空闲后恢复操作。",
    userScope: "用户",
    projectScope: "项目",
    noMatchingCommands: "没有匹配的命令",
    loadingCommands: "正在读取命令…",
    skillHub: "Skill Hub",
    skillHubDescription: "从 pi-skill-hub 兼容的来源挑选技能；先完整预览，再安装到 Pi。",
    skillHubUrl: "GitHub 技能目录链接",
    skillHubUrlPlaceholder: "https://github.com/owner/repo/tree/main/path-to-skill",
    skillHubPreview: "预览",
    skillHubSafety: "仅支持 GitHub HTTPS 目录链接。安装前会列出全部文件，且不会执行技能中的脚本。",
  ...
  "en-US": {
    ...
    filePlugin: "File plugin",
    piSkill: "Pi Skill",
    filePluginDependency: "Disabling the file plugin also disables its Pi Skill; enabling the Pi Skill also enables the file plugin.",
    noResources: "No resources of this type were discovered.",
    resourcesLocked: "A Pi process is working. Skills and Extensions unlock when every process is idle.",
    userScope: "User",
    projectScope: "Project",
    noMatchingCommands: "No matching commands",
    loadingCommands: "Loading commands…",
    skillHub: "Skill Hub",
    skillHubDescription: "Choose skills from pi-skill-hub-compatible sources, review everything, then install them for Pi.",
    skillHubUrl: "GitHub skill directory URL",
    skillHubUrlPlaceholder: "https://github.com/owner/repo/tree/main/path-to-skill",
    skillHubPreview: "Preview",
    skillHubSafety: "GitHub HTTPS directory URLs only. Every file is listed before install; no downloaded script is executed.",
